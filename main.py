...
from asd import scores, MeanCovReg
from solve import ASD
from grid_zoom import grid_zoom

def main(infile, trainPct, nLags, (ro, ssq, delta), doPlot, doMinimize, doGridZoom):
...
if __name__ == '__main__':
    ...
    main(args.infile, args.p, args.m, (args.ro, args.ssq, args.delta), args.plot, args.minimize, args.gridzoom)
